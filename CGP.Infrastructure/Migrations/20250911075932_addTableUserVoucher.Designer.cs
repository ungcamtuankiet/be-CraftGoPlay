...
namespace CGP.Infrastructure.Migrations
{
    ...
    [Migration("20250911075932_addTableUserVoucher")]
    partial class addTableUserVoucher
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CGP.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2025, 9, 11, 14, 59, 29, 886, DateTimeKind.Local).AddTicks(5193),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2025, 9, 11, 14, 59, 29, 886, DateTimeKind.Local).AddTicks(5229),
            ...
            modelBuilder.Entity("CGP.Domain.Entities.FarmLand", b =>
                {
                    ...
                    b.ToTable("FarmLand", (string)null);
                });

            modelBuilder.Entity("CGP.Domain.Entities.FarmlandCrop", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FarmlandId");

                    b.HasIndex("SeedId");

                    b.ToTable("FarmlandCrop", (string)null);
                });
            ...
            modelBuilder.Entity("CGP.Domain.Entities.Item", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CGP.Domain.Entities.OrderAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CGP.Domain.Entities.SaleTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SaleTransaction", (string)null);
                });

            modelBuilder.Entity("CGP.Domain.Entities.ShopPrice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ShopPrice", (string)null);
                });
            ...
            modelBuilder.Entity("CGP.Domain.Entities.UserVoucher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CGP.Domain.Entities.FarmlandCrop", b =>
                {
                    b.HasOne("CGP.Domain.Entities.FarmLand", "Farmland")
                        .WithMany("FarmlandCrops")
                        .HasForeignKey("FarmlandId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CGP.Domain.Entities.Item", "Item")
                        .WithMany("FarmlandCrops")
            ...
            modelBuilder.Entity("CGP.Domain.Entities.OrderAddress", b =>
                {
                    b.HasOne("CGP.Domain.Entities.Order", "Order")
                        ...
                        .HasForeignKey("CGP.Domain.Entities.OrderAddress", "OrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CGP.Domain.Entities.ShopPrice", b =>
                {
                    b.HasOne("CGP.Domain.Entities.Item", "Item")
                        .WithOne("ShopPrice")
                        .HasForeignKey("CGP.Domain.Entities.ShopPrice", "ItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
