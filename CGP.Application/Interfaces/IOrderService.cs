...
namespace CGP.Application.Interfaces
{
    public interface IOrderService
    {
        ...
        Task<Result<bool>> UpdateOrderStatusAsync(Guid orderId, OrderStatusEnum statusDto);
        Task<Result<Guid>> CreateOrderFromCartAsync(Guid userId, List<Guid> selectedCartItemIds, Dictionary<Guid, double> deliveryAmounts, Guid address, string? VoucherCode, PaymentMethodEnum paymentMethod);
